...
export function TeacherDashboardMenu() {
          ...
          >
            ...
            <div className="mt-5 rounded-2xl border border-amber-300/20 bg-amber-400/10 p-4">
              <div className="flex items-start gap-3">
                <CalendarCheck2 className="mt-0.5 h-5 w-5 text-amber-200" />
                <div>
                  <p className="text-sm font-semibold text-white">Attendance matters</p>
                  <p className="mt-1 text-xs text-slate-300">
                    Marking present and absent learners should stay quick.
                  </p>
                </div>
              </div>
            </div>
